import grammar.SetElementsGrBaseVisitor;
...
public class Visitor extends SetElementsGrBaseVisitor<String> {

    List<String> errors = new ArrayList<>();
    Variables variables = new Variables();
    Map<String, String> functions = new HashMap<>();
    Map<String, SetElementsGrParser.SignatureFunctionContext> functionSignatures = new HashMap<>();

    @Override
    public String visitDeclaration(SetElementsGrParser.DeclarationContext ctx) {
        String buffer = "";
    ...
    @Override
    public String visitProgram(SetElementsGrParser.ProgramContext ctx) {
        String buffer = program;
        String buffer1 = "";
        for (SetElementsGrParser.FunctionReturnContext context : ctx.functionReturn())
            buffer1 += visitFunctionReturn(context);
        for (SetElementsGrParser.FunctionNonReturnContext context : ctx.functionNonReturn())
    ...
    @Override
    public String visitBlock(SetElementsGrParser.BlockContext ctx) {
        variables.increase();
        String buffer = "{\n";
        for (SetElementsGrParser.ContentContext context : ctx.content())
    ...
    @Override
    public String visitPrint(SetElementsGrParser.PrintContext ctx) {
        return "\tSystem.out.println(" + ctx.LINE().getText() + ");";
    }

    @Override
    public String visitPrintSet(SetElementsGrParser.PrintSetContext ctx) {
        if (variables.get(ctx.NAME().getText()) == null) {
    ...
    @Override
    public String visitExpression(SetElementsGrParser.ExpressionContext ctx) {
    ...
    @Override
    public String visitContent(SetElementsGrParser.ContentContext ctx) {
        if (ctx.print() != null)
    ...
    @Override
    public String visitInputSignature(SetElementsGrParser.InputSignatureContext ctx) {
        return ctx.getText();
    }

    @Override
    public String visitType(SetElementsGrParser.TypeContext ctx) {
        if (ctx.SET() != null)
            return "Set";
        if (ctx.ELEMENT() != null)
            return "Element";
    ...
    @Override
    public String visitSignatureFunction(SetElementsGrParser.SignatureFunctionContext ctx) {
        String buffer = "(";
    ...
    @Override
    public String visitFunctionReturn(SetElementsGrParser.FunctionReturnContext ctx) {
        String buffer = "";
    ...
    @Override
    public String visitFunctionNonReturn(SetElementsGrParser.FunctionNonReturnContext ctx) {
        String buffer = "";
        if (functions.get(ctx.NAME().getText()) == null)
    ...
    @Override
    public String visitBlockReturn(SetElementsGrParser.BlockReturnContext ctx) {
        String buffer = "{\n";
        for (SetElementsGrParser.ContentContext context : ctx.content())
            buffer += visitContent(context) + "\n";
    ...
    @Override
    public String visitBlockNonReturn(SetElementsGrParser.BlockNonReturnContext ctx) {
        String buffer = "{\n";
        for (SetElementsGrParser.ContentContext context : ctx.content())
            buffer += visitContent(context) + "\n";
        buffer += "return;\n}\n";
    ...
    @Override
    public String visitFunctionCall(SetElementsGrParser.FunctionCallContext ctx) {
        String buffer = "";
        if (functions.get(ctx.NAME().getText()) == null) {
    ...
    @Override
    public String visitSimpleCompare(SetElementsGrParser.SimpleCompareContext ctx) {
        String buffer = "";
    ...
    @Override
    public String visitEqualCompare(SetElementsGrParser.EqualCompareContext ctx) {
        String buffer = "";
        if (ctx.EQUAL() != null)
    ...
    @Override
    public String visitCompare(SetElementsGrParser.CompareContext ctx) {
        String buffer = "";
    ...
    @Override
    public String visitSizeExpression(SetElementsGrParser.SizeExpressionContext ctx) {
        return ctx.getText();
    }

    @Override
    public String visitNegationCompare(SetElementsGrParser.NegationCompareContext ctx) {
        return "!(" + visitSimpleCompare(ctx.simpleCompare()) + ")";
    }

    @Override
    public String visitElseBlock(SetElementsGrParser.ElseBlockContext ctx) {
        String buffer = "";
    ...
    @Override
    public String visitIfBlock(SetElementsGrParser.IfBlockContext ctx) {
        String buffer = "";
    ...
    @Override
    public String visitWhileBlock(SetElementsGrParser.WhileBlockContext ctx) {
        String buffer = "";
        if (ctx.simpleCompare() != null)
    ...
    @Override
    public String visitDeclarationElement(SetElementsGrParser.DeclarationElementContext ctx) {
        String buffer = "";
        if (variables.get(ctx.NAME().getText()) != null) {
            if (ctx.ELEMENT() != null) {
                errors.add("Initialize error: Variable " + ctx.NAME().getText() + " already used");
    ...
    @Override
    public String visitIndexOfExpression(SetElementsGrParser.IndexOfExpressionContext ctx) {
        return ctx.getText();
    }

    @Override
    public String visitGetExpression(SetElementsGrParser.GetExpressionContext ctx) {
        return ctx.getText();
    }

    @Override
    public String visitSetExpression(SetElementsGrParser.SetExpressionContext ctx) {
        for (int i = 0; i < ctx.NAME().size(); i++) {
    ...
    boolean checkSignatures(SetElementsGrParser.InputSignatureContext in, SetElementsGrParser.SignatureFunctionContext sig) {
        boolean check = true;
        if (sig == null && in == null)
           return true;
        if (sig == null || in == null)
